...
<section class="listaResultados">
    <div class = "contenedor" id="contenedor">
        ...
        //preguntamos si se ha enviado el formulario con un texto para buscar registros en la BD
            ...
            echo '<div id="r1">Presione una letra para buscar apellidos de pacientes que inicien con la letra seleccionada
            o, <br><br> ingrese una letra, un apellido, o parte de un apellido en campo mostrado para realizar una búsqueda<br><br>
            Si deja el campo vacío y presiona la lupa, se listan todos los pacientes registrados en la base de datos.</div>';
        }
        ?>
            ...
            <div class="registro">
                ...
                <?php
                    ...
                    if (isset($_REQUEST["msj"])){
                        if ($_REQUEST["msj"] == "ingreso"){
                            echo "el registro del paciente se realizó existosamente";

                        }else if ($_REQUEST["msj"] == "edicion"){
                            echo "el registro del paciente se actualizó existosamente";
                        }
