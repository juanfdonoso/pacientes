...
<section class="listaResultados">
    <form method = "post" action = "nuevoPaciente_xt.php" id="f1">
        ...
        <div class="form-container"> 
            ...
            <div class="formulario"><textarea name="diagnostico" rows="5" cols="40" id="c8" onFocus="borrarCampo('c8')">Escriba aquí el diagnóstico</textarea></div>

            <div class="iconos"><i class="far fa-comments"></i></div>
            <div class="formulario"><textarea name="enteraste" rows="3" cols="40" id="c9"  onFocus="borrarCampo('c9')">Escriba aquí cómo te enteraste del CITeR</textarea></div>
            ...
            <?php
                if (isset($_REQUEST["error"])){
                    if ($_REQUEST["error"] == "repetido"){
                        echo "El email que acaba de ingresar ya se encuentra registrado en el sistema";
                    }
                }
