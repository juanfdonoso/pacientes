...
if (isset($_POST["nombre"])){
    ...
    //Eso lo checamos viendo que el recordset obtenido no tenga filas
    ...
    if (mysqli_num_rows($rs) != 0){
        ...
        $sql = "insert into juanf_A_pacientes (nombre, apellido, genero, fechaNacimiento, escolaridad, email, telefono, diagnostico, comoEnteraste, pw) values('$nombre', '$apellido', '$genero', '$fecha', '$escolaridad', '$email', '$telefono', '$diagnostico', '$enteraste', '$pw')";
        $nada = ejecutar($sql);
        ...
        echo '<script language="javascript">';
        echo 'window.location.assign("index.php?id='.$ultimoIdIngresado.'&msj=ingresar");';
        echo '</script>';
    }
